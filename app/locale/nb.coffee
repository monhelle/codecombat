module.exports = nativeDescription: "Norsk Bokmål", englishDescription: "Norwegian (Bokmål)", translation:
  new_home:
    slogan: "Den mest engasjerende måten å lære ekte koding."
...
#    classroom_in_a_box: "A classroom in-a-box for teaching computer science." 
    codecombat_is: "CodeCombat er en plattform <strong> for studenter </strong> å lære informatikk mens de spiller et ekte spill". 
...
#    democratizing: "Democratizing the process of learning coding is at the core of our philosophy. Everyone should be able to learn to code."
    ...
    wanted_to_do: "Koding er noe jeg alltid hadde lyst å holde på med, men jeg trodde aldri jeg ville få muligheten til å lære det på skolen"
#    builds_concepts_up: "I like how CodeCombat builds the concepts up. It's really easy to understand and fun to figure it out." "Jeg liker måten CodeCombat bygger gradvis opp begreper. Det er veldig lett å forstå og gøy å finne ut av."
    why_games: "Hvorfor er det viktig å lære gjennom spill?"
    games_reward: "Spill belønner det produktive strevet."
#    encourage: "Gaming is a medium that encourages interaction, discovery, and trial-and-error. "A good game challenges the player to master skills over time, which is the same critical process students go through as they learn." Gaming er en metode som oppfordrer til samhandling, oppdagelse, og prøve-og-feile. Et godt spill utfordrer spilleren til å mestre ferdigheter over tid, som er den samme kritiske prosessen elevene går gjennom når de lærer". 
...
#    request_demo_subtitle: "Request a demo and get your students started in less than an hour."
    get_started_title: "Opprett din egen klasse i dag"
    get_started_subtitle: "Opprett en klasse, legg til studentene dine og følg med på utviklingen deres mens de lærer seg informatikk."
    request_demo: "Be om prøvetilgang"
    setup_a_class:  "Opprett en klasse"
    have_an_account: "Har du en konto?"
    logged_in_as: "Du er for øyeblikket logget inn som"
...
#    winning: "A winning combination of RPG gameplay and programming homework that pulls off making kid-friendly education legitimately enjoyable."
    run_class: "Alt du trenger for å sette i gang en programmeringsklasse på skolen din i dag. Ingen bakgrunn i informatikk er nødvendig."
    goto_classes: "Gå til klassene mine"
    view_profile: "Vis profilen min"
    view_progress: "Vis Framgang"
    go_to_courses: "Gå til mine kurs"
    want_coco: "Ønsker du å bruke CodeCombat på din skole?"
...
#    open_source: "Open source (GitHub)"
    ...
    copyright_suffix: "Alle rettigheter forbeholdes"
...
#    apcsp: "AP CS Principles"
  ...
  play:
   anon_signup_title_1:  "CodeCombat har en"
    ...
    anon_signup_enter_code: "Skriv inn klassekode"
    anon_signup_ask_teacher: "Har du ikke en? Spør læreren din!"
   anon_signup_create_class:  "Ønsker du å opprette en klasse?"
    anon_signup_setup_class: "Opprett en klasse, legg til elever og følg med på utviklingen deres!"
    anon_signup_create_teacher:  "Opprett en gratis lærerkonto"
    play_as: "Spill som" # Ladder page
    get_course_for_class: "Tildel spillutvkling og diverse til klassene dine!"
    request_licenses: "Kontakt våre skolespesialister for detaljer"
...
#    subscriber_gems: "Subscribe today to purchase this hero with gems!"
    ...
    brain_pop_done: "Du har slått trollene med kode! Du vant!"
    brain_pop_challenge: "Utfordre deg selv til å spille på nytt med et annet programmeringsspråk!"
...
#    complete_subscription: "Complete Subscription"
    ...
    sign_in_to_continue: "Logg inn eller opprett en konto for å forsette"
