...
#    victory_no_progress_for_teachers: "Progress is not saved for teachers. But, you can add a student account to your classroom for yourself."
    ...
    hints: "Hint"
    hints_title: "Hint {{nummer}}" #hint {{number]]
...
#    tip_free_your_mind: "You have to let it all go, Neo. Fear, doubt, and disbelief. Free your mind. - Morpheus"
    tip_strong_opponents: Selv den sterkeste motstanderen har en svakhet - Itachi Uchiha
    tip_paper_and_pen: Du kan alltids planlegge med penn og papir før du starter å kode 
    tip_solve_then_write: "Først, løs problemet. Deretter, skriv koden. - John Johnson" 
    tip_compiler_ignores_comments: "Noen ganger tror jeg at kompilatoren ignorerer kommentarene mine" 
    tip_understand_recursion: "Den eneste måten å forstå rekursjon er å forstå rekursjon" 
#    tip_life_and_polymorphism: "Open Source is like a totally polymorphic heterogeneous structure: All types are welcome."
    tip_mistakes_proof_of_trying: Feil i koden er bare bevis på at du prøver
    tip_adding_orgres: "Samler trollene"
    tip_sharpening_swords: "Sliper sverdene."
    tip_ratatouille: Du må ikke la andre definere dine begrensninger basert på hvor du kommer i fra. Din eneste begrensning er din sjel. - Gusteau, Ratatouille"
    tip_nemo: "Når livet drar deg ned, vet du hva du må gjøre? Fortsett å svømme, fortsett å svømme. - Dory, Finding Nemo"
    tip_internet_weather: "Bare flytt til Internettet, det er supert her. Vi kan bo her inne hvor været alltid er fantastisk. - John Green"
#    tip_nerds: "Nerds are allowed to love stuff, like jump-up-and-down-in-the-chair-can't-control-yourself love it. - John Green"
    tip_self_taught: "Jeg har selv lært meg 90% av det jeg har lært. Og det er normalt! - Hank Green" 
    tip_luna_lovegood: "Slapp av, du er like normal som jeg er. - Luna Lovegood"
    tip_good_idea: "Den beste måten å ha en god idè er å ha mange ideer. - Linus Pauling"
    tip_programming_not_about_computers: "Informatikk handler like mye om datamaskiner som astronomi om teleskoper.- Edsger Dijkstra"
    tip_mulan: "Tro du kan, da kan du. - Mulan"
    project_complete: "Prosjektet er fullført!"
    share_this_project: "Del prosjektet ditt med venner eller familie:"
...
#    click_publish: "Click \"Publish\" to make it appear in the class gallery, then check out what your classmates built! You can come back and continue to work on this project. Any further changes will automatically be saved and shared with your classmates."
    already_published_prefix:  "Endringene dine har blitt publisert i klasseutstillingen"
#    already_published_suffix: "Keep experimenting and making this project even better, or see what the rest of your class has built! Your changes will automatically be saved and shared with your classmates."
    view_gallery: "Se utstilling"
    project_published_noty: "Nivået ditt har blitt publisert!"
...
#  amazon_hoc:
#    title: "Fortsett å lære med Amazon!"
...
#    educate_1: "Now, keep learning about coding and cloud computing with AWS Educate, an exciting, free program from Amazon for both students and teachers. With AWS Educate, you can earn cool badges as you learn about the basics of the cloud and cutting-edge technologies such as gaming, virtual reality, and Alexa."
    educate_2: "Lær mer og opprett bruker her"
...
#  play_game_dev_level:
    created_by: "Laget av {{navn}}"
#    created_during_hoc: "Created during Hour of Code"
#    restart: "Spill nivået på nytt"
#    play: "Spill nivå"
    play_more_codecombat: "Spill mer CodeCombat"
#    default_student_instructions: "Click to control your hero and win your game!"
    goal_survive: "Overlev"
#    goal_survive_time: "Overlev i ___sekunder__ sekunder."
    goal_defeat: "Bekjemp alle fiender"
#    goal_defeat_amount: "Defeat __amount__ enemies."
    goal_move: "Beveg deg til alle de røde X markørene"
    goal_collect: "Samle alle gjenstandene"
#    goal_collect_amount: "Samle __antall__ gjenstander."
