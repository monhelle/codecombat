module.exports = nativeDescription: "Norsk Bokmål", englishDescription: "Norwegian (Bokmål)", translation:
  new_home:
    slogan: "Den mest engasjerende måten å lære seg ekte kode"
    ...
    learn_more: "Lær mer"
    classroom_in_a_box:  "Virtuelt klasserom for å lære informatikk/programmering"
    codecombat_is: "Codecombat er en plattform hvor elever kan lære seg informatikk mens de spiller gjennom et ekte spill."
    our_courses: "Våre kurs har spesifikt blitt spilltestet for å utmerke seg i klasserommet, selv for lærere som har lite til ingen programmeringserfaring fra før av."
    watch_how: "Se hvordan CodeCombat endrer måten folk lærer informatikk."
   top_screenshots_hint: "Elever skriver kode og ser endringene deres i sanntid"
    ...
    educator_resources: "Lærerressurser"
    course_guides: "og kursinstruksjoner"
    teaching_computer_science: "Man trenger ikke koste på seg dyr utdanning innen informatikk, her gir vi verktøy som støtter lærere med all slags erfaring.
    accessible_to: "Tilgjengelig for"
    everyone: "alle"
   democratizing: "Å allmenngjøre prosessen med å lære programmering er kjernen i vår filosofi. Alle burde ha mulighet til å lære å kode."
    forgot_learning: "Jeg tror de glemte at de faktisk lærte noe." # {change}
    wanted_to_do: "Programmering er noe jeg alltid hadde lyst til å gjøre, og jeg trodde aldri jeg fikk muligheten til å lære det på skolen. "
...
#    agency: "CodeCombat is a game that gives players that agency and confidence with our robust typed code engine, which helps beginner and advanced students alike write proper, valid code."
    request_demo_title:   Få elevene dine i gang i dag!
    request_demo_subtitle:   Be om en prøveversjon og få i gang elevene dine på under en time.
    get_started_title: Lag din egen klasse i dag.
    get_started_subtitle: Lag en klasse, legg til elevene dine, og følg med på framgangen deres mens de lærer seg informatikk
    request_demo: "Be om en prøveversjon"
...
#    computer_science: "Our self-paced courses cover basic syntax to advanced concepts"
   ...
   courses_available_in: "Kursene er tilgjengelige i JavaScript og Python. Webutviklingskurs bruker HTML, CSS og jQuery."
#    boast: "Boasts riddles that are complex enough to fascinate gamers and coders alike."
#    winning: "A winning combination of RPG gameplay and programming homework that pulls off making kid-friendly education legitimately enjoyable."
     run_class:  "Alt du trenger for å gjennomføre programmering som fag på skolen din i dag, ingen erfaring i informatikk nødvendig"
  ...
  nav:
    ...
    other:  "Annet"
    learn_to_code:  "Lær å kode!"
#    toggle_nav: Bytte navigasjon (?)
    schools: "Skoler"
    get_involved: "Bli involvert"
    open_source: "Åpen ressurs (GitHub)"
    support:  "Hjelp"
    faqs: "Ofte stilte spørsmål" 
   copyright_prefix: "Opphavsrett"
    copyright_suffix: "Alle rettigheter forbeholdt"
    help_pref: "Trenger du hjelp? Send e-post"
    help_suff: "og vi vil kontakte deg!"
    resource_hub:  "Ressurssenter"
#    apcsp: "AP CS Principles"
  ...
  play:
    ...
    anon_signup_title_2:  "klasseromsversjon!"
    anon_signup_enter_code:  "Skriv inn klassekoden:"
    anon_signup_ask_teacher: "Har du ikke en? Spør læreren din!"
    anon_signup_create_class:  "Har du lyst å opprette en klasse?"
    anon_signup_setup_class: "Lag en klasse, legg til elevene dine og følg med på framgangen deres!"
   anon_signup_create_teacher:  "Opprett en gratis lærerkonto"
    play_as: "Spill som" # Ladder page
    get_course_for_class:  "Tildel Spillutvikling og flere kurs til dine klasser!"
    request_licenses:  "Kontakt våre skolespesialister for detailjer"
...
#    poll: "Poll" # Tooltip on poll button from /play
    ...
    change_hero_or_language: "Bytt helt eller programmeringsspråk"
    buy_gems: "Kjøp Juveler"
   subscribers_only:  "Bare for abonnementer"
    subscribe_unlock:  "Abonnér for å låse opp!"
    subscriber_heroes:  "Abonnér i dag for å låse opp Amara, Hushbaum og Hattori umiddelbart!"
    subscriber_gems: "Abonnér i dag for å kjøpe denne helten med juveler"
    ...
    brain_pop_done:  "Du har beseiret trollene med kode! Du vinner!"
    brain_pop_challenge:  Utfordre deg selv ved å spille igjen ved å bruke et annet programmeringsspråk!"
    replay: "Spill igjen"
    back_to_classroom:  "Tilbake til klasserom"
    teacher_button:  "For lærere"
  ...
  signup:
    complete_subscription: "Fullt abonnement"
    ...
    sign_in_to_continue: "Logg på eller opprett en konto for å fortsette"
    teacher_email_announcements: "Hold meg oppdatert på nye lærerressurser, læreplaner og kurs!"
